                        ...
                        <div class="d-flex col-lg-5">
                            <div class=" text-capitalize justify-content-left">
                                <div class=" col-lg-12">
                                    ...
                                    <h3 class="text-uppercase">web developer</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="d-flex justify-content-center align-items-center p-2">
            <div class="">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-sm-2">
                            <div class=" d-flex justify-content-left">
                                <img src="assets/img/imgp.jpg" class="img-fluid" alt="">
                            </div>
                    </div>
                    <div class="col-sm-6">
                        <!-- <div class="blockquote" > -->
                            <h2 class="headline mb-3 text-capitalize ">hello, I am chris!</h2>
                                <p> Currently, I am learning<span><span class="blue text-uppercase"> web </span></span> <span>and</span><span class="blue text-uppercase"> android </span> Development.<br>
                                    ...
                                    I deal with different web frameworks such as <span class="blue">bootstrap</span>, <span class="blue">google's flutter<span class="text-white"> and </span>php-laravel.</span>
                                </p>
                        <!-- </div> -->
                    </div>
                </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-2 text-lowercase">
                            <div class="wel_item d-flex justify-content-center">
                                <a href="https://github.com/masakachristopher" class="social_link" title="github"><span>github</span></a>
                            </div>
                        </div> 
                        <div class="col-md-2 text-lowercase">
                            <div class="wel_item d-flex justify-content-center">
                                <a href="https://www.instagram.com/christopher_masaka/?hl=en" class="social_link" title="instagram"><span>instagram</span></a>
                            </div>
                        </div> 
                        <div class="col-md-2 text-lowercase">
                            <div class="wel_item d-flex justify-content-center">
                                <a href="https://developer.cisco.com/chrisdevnet" class="social_link" title="cisco DevNet"><span>cisco devnet</span></a>
                            </div>
                        </div> 
                        <div class="col-md-2 text-lowercase">
                            <div class="wel_item d-flex justify-content-center">
